...
- [ ] spec-001: `./raw/README.md` を作成（コンベンション明記）
- [ ] spec-001: `./raw/{articles,gists,papers,transcripts}/` を作成し `.gitkeep` を配置
- [ ] spec-001: `.gitignore` を確認し `docs/architecture.md` に `raw/` を追記
